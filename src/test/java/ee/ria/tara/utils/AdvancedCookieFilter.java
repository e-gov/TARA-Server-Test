 ...
 * It matches the cookies to the request URL within the rules implemented in DefaultCookieSpec.
 * It might come in handy when more than just the SessionFilter and browser-like cookie matching is needed.
 * For example:
 * <pre>
 ...
 * </pre>
 */
public class AdvancedCookieFilter implements Filter {
